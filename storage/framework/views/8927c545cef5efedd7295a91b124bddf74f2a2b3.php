<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.adverts.categories.attributes.store', $category)); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input id="sort" type="text" class="form-control<?php echo e($errors->has('sort') ? ' is-invalid' : ''); ?>" name="sort" value="<?php echo e(old('sort')); ?>" required>
        ...
        <div class="form-group">
            ...
            <select id="type" class="form-control<?php echo e($errors->has('type') ? ' is-invalid' : ''); ?>" name="type">
                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type); ?>"<?php echo e($type == old('type') ? ' selected' : ''); ?>><?php echo e($label); ?></option>
        ...
        <div class="form-group">
            ...
            <textarea id="variants" type="text" class="form-control<?php echo e($errors->has('sort') ? ' is-invalid' : ''); ?>" name="variants"><?php echo e(old('variants')); ?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="required" <?php echo e(old('required') ? 'checked' : ''); ?>> Required
                </label>
            </div>
